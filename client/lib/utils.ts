 ...
 *
 * @param {Date | string} createdAt - The timestamp to be converted (can be Date object or string).
 * @returns {string} A human-readable time difference string (e.g., "5 minutes ago").
 */
export const getTimestamp = (createdAt: Date | string | null | undefined): string => {
...
/**
 * Formats a Date object or string into a string that represents the month and year.
 *
