  ...
  async function onSubmit(values: z.infer<typeof QuestionsSchema>) {
    ...
    try {
      if (type === 'edit') {
         ...
         * Edit a question
         */
        await apiService.put(`/api/questions/${parsedQuestionDetails?.id}/`, {
          title: values.title,
          content: values.explanation,  // Changed from content to match Django field
          tag_names: values.tags       // Added tag updates for edit
        });
         ...
         */
        await apiService.post('/api/questions/', {
          title: values.title,
          content: values.explanation,
          tag_names: values.tags  // Changed from tags to tag_names
          // author is automatically set from the authenticated user in Django
        });
